...
describe('SassList', () => {
  ...
  describe('Sass to JS index conversion', () => {
    ...
    it('rejects a non-number', () => {
      expect(() => list.sassIndexToListIndex(new SassString('foo'))).toThrow();
    });
  ...
  describe('a scalar value', () => {
    ...
    describe('Sass to JS index conversion', () => {
      ...
      it('rejects invalid indices', () => {
        expect(() => string.sassIndexToListIndex(new SassNumber(0))).toThrow();
        expect(() => string.sassIndexToListIndex(new SassNumber(2))).toThrow();
        expect(() => string.sassIndexToListIndex(new SassNumber(-2))).toThrow();
      });
    });
