...
then
    ...
    then
      ...
      touch spec/libsass-todo-issues/issue_$3/{input.scss,output.css}
    ...
    then
      ...
      touch spec/libsass-closed-issues/issue_$3/{input.scss,output.css}
...
# touch spec/libsass-todo-issues/issue_$1/{input.scss,output.css}
