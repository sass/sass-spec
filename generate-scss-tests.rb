...
def assert_equal(whatever, sass)
  blah = caller[0][/`.*'/][1..-2]
  name = "%03d_%s.scss" % [$COUNT, blah]
  File.open(name, "w") { |file| file.write(sass) }
  $COUNT = $COUNT + 1
end



test_one_line_comments
test_variables
test_unicode_variables
test_guard_assign
test_sass_script
# test_debug_directive
# test_warn_directive
test_for_directive
test_if_directive
test_comment_after_if_directive
test_while_directive
test_each_directive
test_destructuring_each_directive
test_css_import_directive
test_media_import
test_dynamic_media_import
test_http_import
test_protocol_relative_import
test_import_with_interpolation
test_url_import
test_block_comment_in_script
test_line_comment_in_script
test_nested_rules
test_nested_rules_with_declarations
test_nested_rules_with_fancy_selectors
test_almost_ambiguous_nested_rules_and_declarations
test_newlines_in_selectors
test_trailing_comma_in_selector
test_parent_selectors
test_parent_selector_with_subject
test_unknown_directive_bubbling
test_namespace_properties
test_several_namespace_properties
test_nested_namespace_properties
test_namespace_properties_with_value
test_namespace_properties_with_script_value
test_no_namespace_properties_without_space
# test_no_namespace_properties_without_space_even_when_its_unambiguous
test_basic_mixins
test_mixins_with_empty_args
test_mixins_with_args
test_basic_function
test_function_args
test_mixin_var_args
test_mixin_empty_var_args
test_mixin_var_args_act_like_list
test_mixin_splat_args
test_mixin_splat_expression
test_mixin_splat_args_with_var_args
test_mixin_splat_args_with_var_args_and_normal_args
test_mixin_splat_args_with_var_args_preserves_separator
test_mixin_var_and_splat_args_pass_through_keywords
test_mixin_var_keyword_args
test_mixin_empty_var_keyword_args
test_mixin_map_splat
test_mixin_map_and_list_splat
test_mixin_map_splat_takes_precedence_over_pass_through
test_mixin_list_of_pairs_splat_treated_as_list
test_mixin_splat_after_keyword_args
test_mixin_keyword_args_after_splat
test_mixin_keyword_splat_after_keyword_args
test_mixin_triple_keyword_splat_merge
test_function_var_args
test_function_empty_var_args
test_function_var_args_act_like_list
test_function_splat_args
test_function_splat_expression
test_function_splat_args_with_var_args
test_function_splat_args_with_var_args_and_normal_args
test_function_splat_args_with_var_args_preserves_separator
test_function_var_and_splat_args_pass_through_keywords
test_function_var_keyword_args
test_function_empty_var_keyword_args
test_function_map_splat
test_function_map_and_list_splat
test_function_map_splat_takes_precedence_over_pass_through
test_ruby_function_map_splat_takes_precedence_over_pass_through
test_function_list_of_pairs_splat_treated_as_list
test_function_splat_after_keyword_args
test_function_keyword_args_after_splat
test_function_keyword_splat_after_keyword_args
test_function_triple_keyword_splat_merge
test_function_var_args_passed_to_native
test_basic_selector_interpolation
test_selector_only_interpolation
test_selector_interpolation_before_element_name
test_selector_interpolation_in_string
test_selector_interpolation_in_pseudoclass
test_selector_interpolation_at_class_begininng
test_selector_interpolation_at_id_begininng
test_selector_interpolation_at_pseudo_begininng
test_selector_interpolation_at_attr_beginning
test_selector_interpolation_at_attr_end
test_selector_interpolation_at_dashes
test_selector_interpolation_in_reference_combinator
test_parent_selector_with_parent_and_subject
test_basic_prop_name_interpolation
test_prop_name_only_interpolation
test_directive_interpolation
test_media_interpolation
test_script_in_media
test_media_interpolation_with_reparse
test_moz_document_interpolation
test_supports_with_expressions
test_supports_bubbling
test_random_directive_interpolation
test_nested_mixin_def
test_nested_mixin_shadow
test_nested_function_def
test_nested_function_shadow
test_simple_at_root
test_at_root_with_selector
test_at_root_in_mixin
test_at_root_in_media
test_at_root_in_bubbled_media
test_at_root_in_unknown_directive
test_at_root_with_parent_ref
test_multi_level_at_root_with_parent_ref
test_multi_level_at_root_with_inner_parent_ref
test_at_root_without_media
test_at_root_without_supports
test_at_root_without_rule
test_at_root_without_unknown_directive
test_at_root_without_multiple
test_at_root_without_all
test_at_root_with_media
test_at_root_with_rule
test_at_root_with_supports
test_at_root_with_unknown_directive
test_at_root_with_multiple
test_at_root_with_all
test_at_root_dynamic_values
test_at_root_interpolated_query
test_at_root_plus_extend
test_selector_script
test_nested_selector_script
test_nested_selector_script_with_outer_comma_selector
test_nested_selector_script_with_inner_comma_selector
test_selector_script_through_mixin
test_selector_script_through_content
test_selector_script_through_function
test_selector_script_through_media
test_selector_script_save_and_reuse
test_selector_script_with_at_root
test_multi_level_at_root_with_inner_selector_script
test_at_root_with_at_root_through_mixin
# test_nested_mixin_def_is_scoped
# test_rules_beneath_properties
# test_uses_property_exception_with_star_hack
# test_uses_property_exception_with_colon_hack
# test_uses_rule_exception_with_dot_hack
# test_uses_property_exception_with_space_after_name
# test_uses_property_exception_with_non_identifier_after_name
# test_uses_property_exception_when_followed_by_open_bracket
# test_script_error
# test_multiline_script_syntax_error
# test_multiline_script_runtime_error
# test_post_multiline_script_runtime_error
# test_multiline_property_runtime_error
# test_post_resolution_selector_error
test_loud_comment_in_compressed_mode
test_parsing_decimals_followed_by_comments_doesnt_take_forever
test_parsing_many_numbers_doesnt_take_forever
test_import_comments_in_imports
test_reference_combinator_with_parent_ref
test_newline_selector_rendered_multiple_times
test_prop_name_interpolation_after_hyphen
test_star_plus_and_parent
test_weird_added_space
test_interpolation_with_bracket_on_next_line
test_interpolation
test_mixin_with_keyword_args
test_passing_required_args_as_a_keyword_arg
test_passing_all_as_keyword_args_in_opposite_order
test_keyword_args_in_functions
test_newlines_removed_from_selectors_when_compressed
test_multiline_var
test_mixin_content
test_empty_content
test_options_passed_to_script
# test_no_buffer_overflow
test_extend_in_media_in_rule